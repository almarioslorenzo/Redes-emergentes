...
Verificación de Interfaces y VLANs (router Parana):
...
Cada VLAN debe tener su propia puerta de enlace (Gateway) (router Parana):
...
Este es el motor que le da vida a las PCs (router Parana):
